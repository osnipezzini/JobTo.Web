...
using DAL;
using JobTo.Web.ViewModels;
using AutoMapper;
using Microsoft.Extensions.Logging;
using JobTo.Web.Helpers;

namespace JobTo.Web.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from JobTo.Web", message);
